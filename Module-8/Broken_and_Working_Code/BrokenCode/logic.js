...
$("#factButton").on("click", function() {
	...
	var number = Math.floor((Math.random() * booFact.length));
	
	// We display the fact from the catFactArray that is in the random position we just generated.
	$("#factText").text(booFact[number])
})

// This array holds all of our Grumpy Cat facts!
var booFact = ["Grumpy was born on April 4, 2012", "Grumpy's unique look comes from feline dwarfism and an underbite", "Grumpy has a brother named Pokey", "Her favorite Friskies food is Savory Shreds"]
